...
describe('Player', () => {
    ...
    let platformCollisionBlocks: PlatformBlock[];
    let animations: Record<
        string,
        { imageSrc: string; frameRate: number; image: HTMLImageElement; frameBuffer: number }
    >;
    ...
    beforeEach(() => {
        ...
        collisionBlocks = [new CollisionBlock(context, { position: { x: 100, y: 100 } })];
